  ...
  changes: [
    {
      ...
      features: [
        ...
        'Navigation: native view transitions – poster and title of a clicked card morph into the details page, which shows the known image and title while the rest loads',
      ],
      fixes: [
